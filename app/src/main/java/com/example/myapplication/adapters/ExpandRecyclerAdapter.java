...
import com.example.myapplication.viewholders.ParentViewHolder;
...
public abstract class ExpandRecyclerAdapter<PVH extends ParentViewHolder, CVH extends ChildCellHolder>
        extends RecyclerView.Adapter<RecyclerView.ViewHolder>
        implements ParentViewHolder.ParentListItemExpandCollapseListener{

    private static final String EXPANDED_STATE_MAP = "ExpandRecyclerAdapter.ExpandedStateMap";
     ...
     * available in {@link ExpandRecyclerAdapter}
     */
     ...
     * {@link ExpandRecyclerAdapter}
     *
     * @param parentItemList List of all {@link ParentListItem} objects to be
     *                       displayed in the RecyclerView that this
     *                       adapter is linked to
     */
    public ExpandRecyclerAdapter(List<? extends ParentListItem> parentItemList) {
        super();
        mParentItemList = parentItemList;
        mItemList = ExpandRecyclerAdapterHelper.generateParentChildItemList(parentItemList);
        mAttachedRecyclerViewPool = new ArrayList<>();
    }

    /**
     * Implementation of OldAdapter.onCreateViewHolder(ViewGroup, int)
     ...
     * @return A new RecyclerView.MyViewHolder
    ...
    /**
     * Implementation of OldAdapter.onBindViewHolder(RecyclerView.MyViewHolder, int)
     * that determines if the list item is a parent or a child and calls through
     * to the appropriate implementation of either {@link #onBindParentViewHolder(ParentViewHolder, int, ParentListItem)}
     * or {@link #onBindChildViewHolder(ChildCellHolder, int, Object)}.
     *
     * @param holder The RecyclerView.MyViewHolder to bind data to
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        if (listItem instanceof ParentWrapper) {
            ...
            throw new IllegalStateException("Incorrect MyViewHolder found");
        } else {
    ...
    /**
     * Callback called from onBindViewHolder(RecyclerView.MyViewHolder, int)
    ...
    /**
     * Implementation of OldAdapter#onAttachedToRecyclerView(RecyclerView).
     * <p>
     * Called when this {@link ExpandRecyclerAdapter} is attached to a RecyclerView.
     *
     * @param recyclerView The {@code RecyclerView} this {@code ExpandRecyclerAdapter}
    ...
    /**
     * Implementation of OldAdapter.onDetachedFromRecyclerView(RecyclerView)
     * <p>
     * Called when this ExpandRecyclerAdapter is detached from a RecyclerView.
     *
     * @param recyclerView The {@code RecyclerView} this {@code ExpandRecyclerAdapter}
     ...
     * {@link ExpandRecyclerAdapter} is attached to.
     * <p>
     ...
     * triggered at the MyViewHolder level.
     *
     * @param parentIndex The index of the parent to expand
     */
